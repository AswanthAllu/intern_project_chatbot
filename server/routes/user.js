...
// Note: The main 'authMiddleware' is applied in server.js before this router is used,
...
router.get('/profile', async (req, res) => {
    try {
        // Find the user by the ID from the auth token and select only the 'profile' field
