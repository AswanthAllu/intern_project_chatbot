...
/**
 * Generate podcast audio by combining TTS segments
 * @param {Array} podcastScript - Array of segments with text and speaker
 * @param {string} outputPath - Path to save the final podcast audio
 */
async function generatePodcastAudio(podcastScript, outputPath) {
    try {
